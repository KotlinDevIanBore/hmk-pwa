...
export function AdminDashboardLayout({ children }: AdminDashboardLayoutProps) {
    ...
    fetch('/api/auth/me')
      ...
      .then((data) => {
        if (data.success && data.user) {
          ...
          if (!data.user.role || !['SUPER_ADMIN', 'ADMIN', 'MODERATOR', 'SUPPORT'].includes(data.user.role)) {
  ...
  const navigation = [
    ...
    { name: 'Reports', href: `/${locale}/admin/reports`, icon: FileText },
    { name: 'User Management', href: `/${locale}/admin/users`, icon: Users },
    { name: 'SMS Templates', href: `/${locale}/admin/sms`, icon: MessageSquare },
